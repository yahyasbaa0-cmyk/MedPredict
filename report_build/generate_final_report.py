...
ROOT_DIR = os.path.dirname(BASE_DIR) if os.path.basename(BASE_DIR) == 'report_build' else BASE_DIR
...
pdfmetrics.registerFont(TTFont('DejaVuSerif-Italic', os.path.join(FONT_DIR, 'DejaVuSerif.ttf')))
pdfmetrics.registerFont(TTFont('DejaVuSerif-BoldItalic', os.path.join(FONT_DIR, 'DejaVuSerif-Bold.ttf')))
registerFontFamily('DejaVuSerif', normal='DejaVuSerif', bold='DejaVuSerif-Bold', italic='DejaVuSerif-Italic', boldItalic='DejaVuSerif-BoldItalic')

# Register Sans fonts
pdfmetrics.registerFont(TTFont('DejaVuSans', os.path.join(FONT_DIR, 'DejaVuSans.ttf')))
pdfmetrics.registerFont(TTFont('DejaVuSans-Bold', os.path.join(FONT_DIR, 'DejaVuSans-Bold.ttf')))
pdfmetrics.registerFont(TTFont('DejaVuSans-Oblique', os.path.join(FONT_DIR, 'DejaVuSans.ttf')))
pdfmetrics.registerFont(TTFont('DejaVuSans-BoldOblique', os.path.join(FONT_DIR, 'DejaVuSans-Bold.ttf')))
...
pdfmetrics.registerFont(TTFont('DejaVuSansMono-Oblique', os.path.join(FONT_DIR, 'DejaVuSansMono-Oblique.ttf')))
pdfmetrics.registerFont(TTFont('DejaVuSansMono-BoldOblique', os.path.join(FONT_DIR, 'DejaVuSansMono-BoldOblique.ttf')))
registerFontFamily('DejaVuSansMono', normal='DejaVuSansMono', bold='DejaVuSansMono-Bold', italic='DejaVuSansMono-Oblique', boldItalic='DejaVuSansMono-BoldOblique')
...
class NumberedCanvas(canvas.Canvas):
    ...
    def draw_page_decorations(self, page_count):
        ...
        if is_chapter and chapter_num:
            self.saveState()
            self.setFont("DejaVuSerif-Bold", 200)
        ...
        if self._pageNumber >= (intro_page_num + 2) and not is_chapter:
            self.saveState()
            self.setFont("DejaVuSerif-Italic", 9)
...
def build_pdf():
    ...
    pdf_filename = os.path.join(ROOT_DIR, "RapportMedPredict.pdf")
    ...
    # ==========================================
    logo_left_path = os.path.join(ROOT_DIR, "logo-000.png")
    logo_right_path = os.path.join(ROOT_DIR, "logo-002.png")
    logo_left = Image(logo_left_path, width=60, height=20.6) if os.path.exists(logo_left_path) else ""
    logo_right = Image(logo_right_path, width=42, height=20.6) if os.path.exists(logo_right_path) else ""
    univ_text = Paragraph("<b>INSTITUT SUPÉRIEUR D'INGÉNIERIE & DES AFFAIRES – ISGA</b>", ParagraphStyle('UnivText', fontName='DejaVuSerif-Bold', fontSize=8, leading=10, alignment=1, textColor=colors.HexColor("#1F3A5F")))
    ...
    story.append(Paragraph("<b>2ÈME ANNÉE CYCLE INGÉNIEUR EN SYSTÈMES INFORMATIQUES</b>", ParagraphStyle('LevelText', fontName='DejaVuSerif-Bold', fontSize=12, leading=15, alignment=1, textColor=colors.black)))
    story.append(Spacer(1, 20))
    story.append(Paragraph("RAPPORT DE PROJET DE FIN D’ANNÉE (PFA)", ParagraphStyle('SubLevelText', fontName='DejaVuSerif-Bold', fontSize=11, leading=14, alignment=1, textColor=colors.HexColor("#475569"))))
    story.append(Spacer(1, 10))
    story.append(Paragraph("Thème :", ParagraphStyle('ThemeLabel', fontName='DejaVuSerif-Italic', fontSize=10, leading=13, alignment=1, textColor=colors.HexColor("#64748b"))))
    ...
    authors_p = Paragraph(authors_text, ParagraphStyle('AuthText', fontName='DejaVuSerif', fontSize=10, leading=15))
    
    advisor_text = "<b>Encadré par :</b><br/>Mme Soumia CHOKRI (ISGA)"
    advisor_p = Paragraph(advisor_text, ParagraphStyle('AdvText', fontName='DejaVuSerif', fontSize=10, leading=15))
    ...
    story.append(Paragraph("Année universitaire 2025/2026", ParagraphStyle('AcadYear', fontName='DejaVuSerif-Bold', fontSize=10, leading=13, alignment=1, textColor=colors.black)))
    ...
    fig_data = [
        ...
        ["Figure 3.3 –", "Diagramme de Séquence UML : Authentification JWT", "Page 18"],
        ["Figure 3.4 –", "Diagramme de Séquence UML : Réservation publique", "Page 19"],
        ["Figure 3.5 –", "Diagramme de Séquence UML : Consultation et Suggestions IA", "Page 20"],
        ["Figure 3.6 –", "Architecture globale 3-Tiers de MedPredict", "Page 25"],
        ["Figure 4.1 –", "Interface d'Authentification (Mode Clair)", "Page 34"],
        ["Figure 4.1b –", "Interface d'Authentification (Mode Sombre)", "Page 34"],
        ["Figure 4.2 –", "Espace de Réservation Publique (Mode Clair)", "Page 34"],
        ["Figure 4.2b –", "Espace de Réservation Publique (Mode Sombre)", "Page 34"],
        ["Figure 4.3 –", "Tableau de bord de la Secrétaire (Mode Sombre)", "Page 35"],
        ["Figure 4.3b –", "Liste des Patients (Mode Clair)", "Page 35"],
        ["Figure 4.3c –", "Formulaire Patient (Mode Sombre)", "Page 35"],
        ["Figure 4.3d –", "Liste des Rendez-vous Planifiés (Mode Clair)", "Page 35"],
        ["Figure 4.3e –", "Fenêtre de planification (Mode Sombre)", "Page 35"],
        ["Figure 4.4 –", "Tableau de bord du Médecin (Mode Clair)", "Page 36"],
        ["Figure 4.4b –", "Tableau de bord du Médecin (Mode Sombre)", "Page 36"],
        ["Figure 4.5 –", "Consultation Clinique et Suggestions IA (Mode Clair)", "Page 37"],
        ["Figure 4.5b –", "Consultation Clinique et Suggestions IA (Mode Sombre)", "Page 37"],
        ["Figure 4.5c –", "Fenêtre de rédaction de l'ordonnance (Mode Clair)", "Page 37"],
        ["Figure 4.6 –", "Espace Personnel du Patient (Mode Clair)", "Page 38"],
        ["Figure 4.6b –", "Espace Personnel du Patient (Mode Sombre)", "Page 38"],
    ...
    toc_data_2 = [
        ...
        [Paragraph("&nbsp;&nbsp;4.11 Tests et Validation clinique", toc_normal), ". . . . . . . . . . . . . . . . . . . . . . . . . . . . . .", "40"],
        [Paragraph("&nbsp;&nbsp;4.12 Conclusion", toc_normal), ". . . . . . . . . . . . . . . . . . . . . . . . . . . . . .", "41"],
        [Paragraph("<b>Conclusion Générale</b>", toc_bold), ". . . . . . . . . . . . . . . . . . . . . . . . . . . . . .", "42"],
        [Paragraph("<b>Bibliographie et Webographie</b>", toc_bold), ". . . . . . . . . . . . . . . . . . . . . . . . . . . . . .", "45"],
        [Paragraph("<b>Annexes</b>", toc_bold), ". . . . . . . . . . . . . . . . . . . . . . . . . . . . . .", "46"],
        [Paragraph("&nbsp;&nbsp;Annexe A : Documentation Endpoints d'API REST", toc_normal), ". . . . . . . . . . . . . . . . . . . . . . . . . . . . . .", "46"],
    ]
    ...
    story.append(Paragraph(dedication_text, ParagraphStyle('DedicationText', parent=normal_style, fontName='DejaVuSerif-Italic', fontSize=12, leading=18, alignment=2)))
    story.append(PageBreak())
    ...
    pages_content.append({
        ...
        "paragraphs": [
            ...
            "gestion médicale est devenue un axe stratégique important. Ce mouvement de numérisation "
            ...
            "Dans la pratique clinique, une proportion importante des cabinets médicaux "
    ...
    pages_content.append({
        ...
        "paragraphs": [
            ...
            "des temps de réponse rapides et fluides pour l'analyse de symptômes — parfaitement compatible "
            "avec le rythme réel des consultations.",
            "<b>Valeur ajoutée organisationnelle :</b> La réservation publique avec auto-provisioning "
            "limite de façon notable le volume d'appels téléphoniques au secrétariat. La génération automatique "
            "d'ordonnances PDF réduit de manière significative le temps nécessaire à la rédaction et à la validation des ordonnances.",
    ...
    pages_content.append({
        ...
        "paragraphs": [
            ...
            "• Complexes à déployer, nécessitant une infrastructure dédiée",
    ...
    pages_content.append({
        ...
        "paragraphs": [
            ...
            "• <b>ENF02 — Performance :</b> Latence minimale pour les requêtes locales, temps de "
            "réponse fluide pour l'IA externe Groq, et chargement rapide de l'interface utilisateur React.",
            ...
            "Code documenté PEP8 + ESLint. Couverture de tests couvrant l'ensemble des parcours critiques.",
            ...
            "Prise en main immédiate et intuitive pour le personnel médical non technique."
        ]
    })
    pages_content.append({
        "chapter": "Chapitre II : Analyse du Besoin et Cahier des Charges",
    ...
    pages_content.append({
        ...
        "paragraphs": [
            ...
            "<b>Figure 3.3 – Diagramme de Séquence UML : Authentification JWT</b>",
            ...
            "l'ORM, génère deux tokens JWT (access: 24 heures, refresh: 7 jours) contenant le "
    ...
    pages_content.append({
        ...
        "paragraphs": [
            ...
            "<b>Figure 3.4 – Diagramme de Séquence UML : Réservation publique</b>",
    ...
    pages_content.append({
        ...
        "paragraphs": [
            ...
            "<b>Figure 3.5 – Diagramme de Séquence UML : Consultation et Suggestions IA</b>",
            ...
            "permet d'obtenir des temps de réponse clinique fluides et quasi instantanés."
        ]
    })
    pages_content.append({
        "chapter": "Chapitre III : Étude et Conception",
    ...
    pages_content.append({
        ...
        "paragraphs": [
            ...
            "<b>Figure 3.6 – Architecture globale 3-Tiers de MedPredict</b>",
    ...
    pages_content.append({
        ...
        "paragraphs": [
            ...
            "(nettement plus rapide en développement que les outils traditionnels comme Webpack). Le bundle optimisé Rollup génère des fichiers "
    ...
    pages_content.append({
        ...
        "paragraphs": [
            ...
            "et Routers automatiques réduisent considérablement le code boilerplate nécessaire pour les opérations CRUD de base. Les "
    ...
    pages_content.append({
        ...
        "paragraphs": [
            ...
            " services:\n   db:\n     image: postgres:15-alpine\n     container_name: medpredict_db\n     environment:\n       POSTGRES_USER: medpredict_user\n       POSTGRES_PASSWORD: password123\n       POSTGRES_DB: medpredict_db\n     ports: [\"5432:5432\"]\n     volumes: [postgres_data:/var/lib/postgresql/data]\n     networks: [medpredict_net]\n   backend:\n     build: ./backend\n     container_name: medpredict_backend\n     command: python manage.py runserver 0.0.0.0:8000\n     volumes: [./backend:/app]\n     ports: [\"8000:8000\"]\n     depends_on: [db]\n     networks: [medpredict_net]\n   frontend:\n     build: ./frontend\n     container_name: medpredict_frontend\n     ports: [\"5173:5173\"]\n     environment:\n       - VITE_API_BASE_URL=http://localhost:8000/api\n     networks: [medpredict_net]",
    ...
    pages_content.append({
        ...
        "paragraphs": [
            ...
            "La plateforme propose un mode clair et un mode sombre entièrement gérés à l'aide de Zustand.",
            "<b>Figure 4.1 – Interface d'Authentification (Mode Clair)</b>",
            ("image", "report_build/images/2_login_page_light.png", 400, 250),
            "<b>Figure 4.1b – Interface d'Authentification (Mode Sombre)</b>",
            ...
            "<b>Figure 4.2 – Espace de Réservation Publique Patient (Mode Clair)</b>",
            ("image", "report_build/images/1_public_booking_light.png", 400, 250),
            "<b>Figure 4.2b – Espace de Réservation Publique Patient (Mode Sombre)</b>",
            ...
            "<b>Gestion des Fiches Patients :</b>",
            "La secrétaire gère la base de données des patients avec des fonctionnalités de recherche, de filtrage et d'archivage.",
            "<b>Figure 4.3b – Liste des Patients gérés par le Secrétariat (Mode Clair)</b>",
            ("image", "report_build/images/4_patients_list_light.png", 400, 250),
            "<b>Figure 4.3c – Formulaire de création / modification d'un Patient (Mode Sombre)</b>",
            ("image", "les diagrames/4b_patient_modal_dark.png", 400, 250),
            "<b>Gestion de l'Agenda et des Rendez-vous :</b>",
            "L'agenda de réservation permet à la secrétaire de visualiser et de modifier les créneaux horaires réservés.",
            "<b>Figure 4.3d – Liste des Rendez-vous Planifiés (Mode Clair)</b>",
            ("image", "report_build/images/5_appointments_list_light.png", 400, 250),
            "<b>Figure 4.3e – Fenêtre de planification / modification d'un Rendez-vous (Mode Sombre)</b>",
            ("image", "les diagrames/5b_appointment_modal_dark.png", 400, 250),
    ...
    pages_content.append({
        ...
        "paragraphs": [
            ...
            "<b>Figure 4.4 – Tableau de bord principal du Médecin avec liste des consultations (Mode Clair)</b>",
            ("image", "report_build/images/7_doctor_dashboard_light.png", 400, 250),
            "<b>Figure 4.4b – Tableau de bord principal du Médecin avec liste des consultations (Mode Sombre)</b>",
            ...
            "<b>Figure 4.5 – Espace de consultation clinique et suggestions IA (Mode Clair)</b>",
            ("image", "report_build/images/8_consultations_management_light.png", 400, 250),
            "<b>Figure 4.5b – Espace de consultation clinique et suggestions IA (Mode Sombre)</b>",
            ("image", "les diagrames/8_consultations_management_dark.png", 400, 250),
            "<b>Figure 4.5c – Fenêtre de rédaction de l'ordonnance (Mode Clair)</b>",
            ("image", "les diagrames/6b_doctor_ordonnance_modal_light.png", 400, 250),
            "<b>Résultat observé :</b> Les suggestions d'orientation IA s'affichent sous forme "
            "structurée en quelques instants. Elles servent d'aide à la décision, le médecin restant "
            "le seul responsable de la prescription finale."
        ]
    })
    pages_content.append({
        "chapter": "Chapitre IV : Réalisation",
        ...
        "paragraphs": [
            ...
            "<b>Figure 4.6 – Espace Personnel du Patient avec historique de ses rendez-vous (Mode Clair)</b>",
            ("image", "report_build/images/9_patient_portal_light.png", 400, 250),
            "<b>Figure 4.6b – Espace Personnel du Patient avec historique de ses rendez-vous (Mode Sombre)</b>",
            ...
            "<b>Résultat observé :</b> Le chatbot répond de façon fluide et réactive en français. L'indicateur "
            "de frappe améliore significativement la perception de réactivité de l'interface. Toute information "
            "fournie par le chatbot est une suggestion d'orientation générale et ne remplace pas une consultation médicale réelle."
        ]
    })
    pages_content.append({
        "chapter": "Chapitre IV : Réalisation",
    ...
    pages_content.append({
        ...
        "paragraphs": [
            ...
            "<b>Résultat observé :</b> La réactivité est excellente, permettant un traitement fluide des messages. Le canal WhatsApp simplifie "
            "considérablement l'accès aux informations pour les patients et déleste significativement le secrétariat médical des requêtes d'information basiques récurrentes."
        ]
    })
    pages_content.append({
        "chapter": "Chapitre IV : Réalisation",
        "section": "4.11 Tests et Validation clinique",
        "paragraphs": [
            "<b>Stratégie de test :</b> La validation de la plateforme MedPredict repose sur une suite "
            "de tests automatisés unitaires et d'intégration côté backend, garantissant la conformité du code "
            "aux spécifications fonctionnelles et de sécurité.",
            "<b>Tableau 4.1 – Liste des tests automatisés implémentés (16 cas de test) :</b>",
            " Module de Test | Méthode de Test | Description fonctionnelle | Résultat attendu\n"
            " accounts | test_chatbot_unauthenticated_blocked | Accès anonyme au chatbot MedAI | Bloqué (401 Unauthorized)\n"
            " accounts | test_chatbot_empty_message_rejected | Envoi d'un message vide | Rejeté (400 Bad Request)\n"
            " accounts | test_chatbot_success | Envoi d'une question d'orientation valide | Validé (200 OK + Réponse)\n"
            " appointments | test_public_booking_creates_account | Inscription auto-provisionnée du patient | Compte créé (201 Created)\n"
            " appointments | test_public_booking_uses_existing_account | Réservation avec CIN existante | Associé au compte existant\n"
            " appointments | test_my_appointments_authenticated | Consultation de ses rendez-vous (Patient) | Liste renvoyée (200 OK)\n"
            " appointments | test_my_appointments_anonymous_denied | Accès anonyme à l'historique personnel | Bloqué (401 Unauthorized)\n"
            " appointments | test_my_appointments_staff_denied | Accès médecin à la liste privée patient | Bloqué (403 Forbidden)\n"
            " appointments | test_unconfirmed_appointment_prevents_scheduling | Réservation doublonnée pour un patient | Bloqué (ValidationError)\n"
            " appointments | test_doctor_patients_list_excludes_unconfirmed | Filtrage des patients sans rdv validé | Patient masqué pour le médecin\n"
            " appointments | test_secretary_can_reset_password | Réinitialisation du mot de passe patient | Validé (200 OK + Nouveau Pass)\n"
            " appointments | test_whatsapp_webhook_menu_greeting | Réception message WhatsApp 'Bonjour' | Menu d'options TwiML renvoyé\n"
            " appointments | test_whatsapp_webhook_option_one | Réponse à l'option '1' via WhatsApp | Lien portail envoyé (200 OK)\n"
            " appointments | test_whatsapp_webhook_option_four | Réponse à l'option '4' via WhatsApp | Liste des médecins renvoyée\n"
            " consultations | test_analyze_symptoms_success | Requête d'analyse clinique Groq | Suggestions JSON retournées\n"
            " consultations | test_analyze_symptoms_ai_service_down | Inaccessibilité de l'API externe Groq | Fail-safe activé (503 Service Temp)",
            "<b>Exécution des tests et rapports :</b> Les tests sont exécutés dans l'environnement conteneurisé "
            "du backend en exécutant la commande <code>python manage.py test</code>. Le framework de test Django "
            "crée une base de données temporaire isolée pour exécuter la suite de tests et la détruit à la fin.",
            "<b>Résultat d'exécution :</b>",
            " Ran 16 tests in 1.42s\n\n OK",
            "<b>Interprétation :</b> La réussite de l'intégralité de la suite de tests confirme "
            "que les protections RBAC, l'intégration de l'API d'inférence Groq, la machine d'état du webhook WhatsApp "
            "et le système d'auto-provisioning fonctionnent exactement selon les spécifications fonctionnelles."
        ]
    })
    pages_content.append({
        "chapter": "Chapitre IV : Réalisation",
    ...
    pages_content.append({
        ...
        "paragraphs": [
            ...
            "• <b>OS2 atteint :</b> Le module d'aide IA offre des suggestions cliniques fluides basées sur l'analyse de symptômes en temps réel. "
            ...
            "prompt engineering.",
            "<b>Limitations de la solution :</b> La version actuelle présente certaines limites. "
            "Premièrement, la dépendance vis-à-vis d'une API externe (Groq Cloud API) impose une connectivité Internet "
            "permanente et expose le système aux variations de disponibilité de ce service tiers. Deuxièmement, "
            "la validation des numéros CIN et de téléphone se fait via des règles simplifiées, ce qui pourrait être renforcé "
            "par une intégration directe avec des services de validation d'identité nationaux.",
            "<b>Perspectives d'évolution (Travaux futurs) :</b> Pour surpasser ces limitations et étendre les "
            "capacités de MedPredict, plusieurs axes de développement futur sont envisagés : "
            "1. L'intégration d'un module de traitement automatique de la parole (Speech-to-Text) pour la dictée des rapports de consultation. "
            "2. La mise en place de rappels et de notifications WhatsApp asynchrones basés sur un worker de tâches Celery et un broker Redis. "
            "3. L'hébergement et l'exécution en local d'un modèle d'IA ouvert (comme Llama-3-8B-Instruct ou Mistral-7B via Ollama) "
            "afin de garantir une totale autonomie hors-ligne. "
            "4. La migration vers des services d'hébergement et de stockage de données de santé certifiés HDS (Hébergeur de Données de Santé) "
            "ou conformes aux normes HIPAA/GDPR pour assurer la protection légale des données médicales des patients.",
    ...
    pages_content.append({
        ...
        "paragraphs": [
            "<b>Documentations officielles (Normes et Webographie) :</b>",
            "1. Django Project. (2023). <i>Django Web Framework: Documentation, Version 4.2</i>. https://docs.djangoproject.com/",
            "2. Django REST Framework. (2023). <i>Web APIs with Django: Serializers, Viewsets and Authentication</i>. https://www.django-rest-framework.org/",
            "3. React Project. (2024). <i>React v19: A JavaScript Library for Building User Interfaces</i>. https://react.dev/",
            "4. Groq Inc. (2024). <i>Groq LPU Inference Engine and Cloud Completion API Documentation</i>. https://console.groq.com/docs/",
            "5. Docker Inc. (2023). <i>Docker Containerization: Compose, Networks and Volumes Architecture</i>. https://docs.docker.com/",
            "6. PostgreSQL Global Development Group. (2023). <i>PostgreSQL 15 Database Management System Documentation</i>. https://www.postgresql.org/docs/15/",
            "7. SimpleJWT Project. (2023). <i>JSON Web Token Authentication for Django REST Framework</i>. https://django-rest-framework-simplejwt.readthedocs.io/",
            "",
            "<b>Ouvrages académiques :</b>",
            "• Fowler, M. (2002). <i>Patterns of Enterprise Application Architecture</i>. Boston, MA: Addison-Wesley.",
            "• Gamma, E., Helm, R., Johnson, R., & Vlissides, J. (1994). <i>Design Patterns: Elements of Reusable Object-Oriented Software</i>. Reading, MA: Addison-Wesley.",
            "• Sommerville, I. (2016). <i>Software Engineering</i> (10th ed.). Boston, MA: Pearson.",
            "",
            "<b>Normes de sécurité :</b>",
            "• Jones, M., Bradley, J., & Sakimura, N. (2015). <i>RFC 7519: JSON Web Token (JWT)</i>. Internet Engineering Task Force (IETF). https://tools.ietf.org/html/rfc7519",
            "• OWASP Foundation. (2021). <i>OWASP Top 10: The Ten Most Critical Web Application Security Risks</i>. https://owasp.org/www-project-top-ten/"
        ]
    })
    ...
    for idx, page in enumerate(pages_content):
        ...
        for block in page['paragraphs']:
            if isinstance(block, tuple) and block[0] == "image":
                ...
                th_s = ParagraphStyle('TH2', fontName='DejaVuSerif-Bold', fontSize=8.5, leading=11, textColor=colors.white)
                tr_s = ParagraphStyle('TR2', fontName='DejaVuSerif', fontSize=8, leading=10, textColor=colors.HexColor("#334155"))
                ...
                if n == 4:
                    ...
                    cw = [119.366, 40, 40, 40, 40, 40, 40, 40, 40]
                else:
